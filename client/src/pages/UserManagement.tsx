                ...
                <TableRow key={user.id}>
                  ...
                  <TableCell>
                    <span style={{ fontFamily: 'monospace' }}>
                      {parseFloat(user.totalBalance || "0").toLocaleString('en-US', { minimumFractionDigits: 2 })} USDT
                    </span>
                  </TableCell>
                  <TableCell>
                    <span style={{ fontFamily: 'monospace' }}>
                      {parseFloat((user as any).totalDeposits || "0").toLocaleString('en-US', { minimumFractionDigits: 2 })} USDT
                    </span>
                  </TableCell>
                  <TableCell>
                    <span
                    ...
                    >
                      {parseFloat((user as any).netProfits || "0").toLocaleString('en-US', { minimumFractionDigits: 2 })} USDT
                    </span>
                  </TableCell>
                  <TableCell>
                    <span style={{ fontFamily: 'monospace' }}>
                      {parseFloat(user.availableBalance || "0").toLocaleString('en-US', { minimumFractionDigits: 2 })} USDT
                    </span>
                  </TableCell>
                  <TableCell>
                    <Button
